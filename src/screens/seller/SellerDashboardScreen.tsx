...
const SellerDashboardScreen: React.FC = () => {
  ...
  const confirmSignOut = () => Alert.alert('Sign Out', 'Sign out of this store account?', [
  ...
  return <SafeAreaView style={styles.container}>
    <View style={styles.top}><View><Text style={styles.topTitle}>{organization.name}</Text><Text style={styles.muted}>Seller Dashboard</Text></View><View style={styles.topActions}><Ionicons name="storefront" size={28} color={COLORS.primary} /><TouchableOpacity style={styles.signOutIcon} onPress={confirmSignOut}><Ionicons name="log-out-outline" size={24} color={COLORS.error} /></TouchableOpacity></View></View>
